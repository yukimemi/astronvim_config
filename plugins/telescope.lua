return {
  ...
  init = function()
    ...
    vim.keymap.set(
      "n",
      "<space>fc",
      function() require("telescope.builtin").git_files { cwd = "~/.cache" } end,
    ...
    vim.keymap.set(
      "n",
      "<space>fj",
      function() require("telescope.builtin").find_files { cwd = "~/.cache/junkfile" } end,
      { desc = "Find junk file" }
    )
